...
namespace CargoTransportationView
{
    ...
    public class MemIniFile
    {
        ...
        {
            var s = ReadString(section, ident, Default.ToString());
            bool b;
        ...
        {
            var s = ReadString(section, ident, Default.ToString("0"));
            int i;
        ...
        {
            WriteString(section, ident, value.ToString("0"));
        }

        public DateTime ReadDateTime(string section, string ident, DateTime Default)
        {
            var s = ReadString(section, ident, Default.ToString("O"));
            return DateTime.TryParse(s, out DateTime i) ? i : Default;
        }

        public void WriteDateTime(string section, string ident, DateTime value)
        {
            WriteString(section, ident, value.ToString("O"));
        }
        ...
        /// <param name="section"></param>
        /// <returns></returns>
        public NameValueCollection ReadSectionNamesAndValues(string section)
        {
