...
namespace CargoTransportation
{
    ...
    public partial class ReportsForm : Form
    {
        ...
        {
            e.PageSettings.Landscape = report.Landscape;
        }
        ...
        private void printDoc_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            PointF strPoint;
            // печать подвалов
            using (var printfont = new Font("Times New Roman", 8, FontStyle.Italic))
            {
            ...
            using (var printfont = new Font("Times New Roman", 16, FontStyle.Bold))
